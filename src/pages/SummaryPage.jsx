    ...
    const fetchSummaryData = async () => {
      ...
      try {
        ...
        const [staffResponse, customerResponse] = await Promise.all([
          axios.get(`${process.env.REACT_APP_BASE_URL}/api/v1/getstaffloginsummary/`, { headers }),
          axios.get(`${process.env.REACT_APP_BASE_URL}/api/v1/getcustomerloginsummary/`, { headers }),
        ]);
